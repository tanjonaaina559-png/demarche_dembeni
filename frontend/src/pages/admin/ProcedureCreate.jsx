    ...
    <AdminLayout adminName="Admin" onLogout={() => logout()}>
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', paddingBottom: '50px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '25px' }}>
          ...
          <div>
            <h1 style={{ fontSize: '1.8rem', color: '#164022', margin: 0 }}>Créer une Démarche Administrative</h1>
            <p style={{ color: 'var(--gris-500)', fontSize: '0.9rem', margin: '5px 0 0' }}>Concevez une démarche 100% dynamique et personnalisée pour les citoyens.</p>
          </div>
        </div>
